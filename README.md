...
#2. install packages npm install express mysql2 dotenv bcryptjs jsonwebtoken nodemon after npm init -y
#3. To start server : nodemon start
#4. Testing API involves using Postman
